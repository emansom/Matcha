...
<body>
        <div id="client">
                <object classid='clsid:166B1BCA-3F9C-11CF-8075-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/director/sw.cab#version=10,8,5,1,0' id='habbo' width='720' height='540'>
                        <param name='src' value='https://images.oldhabbo.com/dcr/v21/habbo.dcr'>
                        ...
                        <param name='sw3' value='client.reload.url=https://test.oldhabbo.com/'>
                        <param name='sw1' value='site.url=https://beta.oldhabbo.com;url.prefix=https://beta.oldhabbo.com'>
                        <param name='sw5' value='external.variables.txt=https://images.oldhabbo.com/dcr/v21/external_variables.txt;external.texts.txt=https://images.oldhabbo.com/dcr/v21/external_texts_nl.txt'>

                        <embed src='https://images.oldhabbo.com/dcr/v21/habbo.dcr' bgColor='#000000' width='720' height='540' swRemote='swSaveEnabled='true' swVolume='true' swRestart='false' swPausePlay='false' swFastForward='false' swTitle='Habbo Hotel' swContextMenu='true'' swStretchStyle='none' swText='' type='application/x-director' pluginspage='http://www.macromedia.com/shockwave/download/'
                        ...
                        sw3='client.reload.url=https://test.oldhabbo.com/'
                        sw1='site.url=https://beta.oldhabbo.com;url.prefix=https://beta.oldhabbo.com'
                        sw5='external.variables.txt=https://images.oldhabbo.com/dcr/v21/external_variables.txt;external.texts.txt=https://images.oldhabbo.com/dcr/v21/external_texts_nl.txt'></embed>
                </object>
        </div>
</body>
</html>
