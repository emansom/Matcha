                        ...
                        <div class="content-white">
                            <div class="content-white-body">
                                <div class="content-white-content">
                                    <center><img src="/c_images/album1358/frank_guide1.gif" alt=""><img src="/c_images/Pages/pointing_at_staff.gif" alt=""></center><br>Staff will <span style="font-weight: bold;">always</span> show the above badge when asked.<br><br>Staff and Moderators
                                    have a Staff badge and are listed on this page.<br></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                    ...
                    <div class="v3box blue">
                        ...
                        <div class="v3box-content">
                            <div class="v3box-body">
                                <p>Here are the guys and gals who make this site what it is. If you see them in the hotel say 'Hi!' and if they are not being mobbed by 17 other users they will be sure to say 'Hi!' back!<br><br></p>
                                <p align="left"></p>
                                <table width="100%" border="0">
                                    <tbody>
                                        <tr>
                                            <td width="984">
                                                <p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><b>Ewout</b></p>
                                                <p align="left" style="margin-top: 0pt; margin-bottom: 0pt;">Ewout is the Hotel Manager and is responsible for all the cool content on these pages! He likes placing teleporters in random rooms and leaving behind notes. Usually he is around from 20:00 PM to 21:00 PM (CEST). <br></p>
                                            </td>
                                            <td>
                                                <p align="left"><img width="72" height="106" border="0" src="/c_images/album1337/Ewout.png" id="galleryImage1" alt="lost witness scream"></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table><br>
                ...
                <td valign="top" style="width: 176px;">
                    <div id="ad_sidebar" style="display: none !important;">
                        <div class="cooperation">
                            <table height="120" width="168" valign="middle" align="center" border="0" cellpadding="0" cellspacing="0" background="https://web.archive.org/web/20071014031643im_/http://images.habbohotel.ch/c_images/themes/partner_box.gif">
                                <tbody>
                                    <tr>
                                        <td>
