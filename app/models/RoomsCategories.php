...
class RoomsCategories extends \Phalcon\Mvc\Model
{
     ...
     *
     * @var integer
     * @Column(column="isnode", type="integer", nullable=false)
     */
    public $isnode;
     ...
     *
     * @var integer
     * @Column(column="public_spaces", type="integer", nullable=false)
     */
     ...
     *
     * @var integer
     * @Column(column="allow_trading", type="integer", nullable=false)
     */
     ...
     *
     * @var integer
     * @Column(column="minrole_access", type="integer", nullable=false)
     */
     ...
     *
     * @var integer
     * @Column(column="minrole_setflatcat", type="integer", nullable=false)
     */
